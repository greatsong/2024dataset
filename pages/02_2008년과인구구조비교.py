...
if input_region:
    ...
    if input_region in regions_2008:
        population_2008 = data_2008.loc[inputregion].drop(['2008년02월계총인구수', '2008년02월계_연령구간인구수'])
        population_2024 = data_2024.loc[inputregion].drop(['2024년06월계총인구수', '2024년06월계_연령구간인구수'])
...
if age_group is not None:
    age_col2024 = f'2024년06월계_{age_group}세'
    age_col2008 = f'2008년02월계_{age_group}세'
