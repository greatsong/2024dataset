...
if input_region:
    ...
    if input_region in regions_2008:
        population_2008 = data_2008.loc[input_region]
        population_2024 = data_2024.loc[input_region]
        
        ax.plot(population_2008, label='2008년')
        ax.plot(population_2024, label='2024년')
...
if age_group is not None:
    age_col = str(age_group)  # Assuming the age columns are named as '0', '1', ..., '100'

    data_2024['Population_2024'] = data_2024[age_col]
    data_2008['Population_2008'] = data_2008[age_col]
